...
var getUserSelf = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requesterId, _a, userError, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("Request object from get self", req);
                requesterId = getRequesterId_1.getRequesterId(req);
                return [4, perhaps_1.perhaps(getUserFromDbById_1.getUserFromDbById(requesterId))];
            case 1:
                ...
                respond_1.respondSuccess({ res: res, data: user });
                return [2];
        }
    });
}); };
exports.getUserSelf = getUserSelf;
