...
var updateWishlist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var wishlistData, _a, updatedWishlistError, updatedWishlist;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                wishlistData = req.body;
                console.log({ wishlistData: wishlistData });
                return [4, perhaps_1.perhaps(putWishlistToDb_1.putWishlistToDb(wishlistData))];
            case 1:
                _a = _b.sent(), updatedWishlistError = _a[0], updatedWishlist = _a[1];
